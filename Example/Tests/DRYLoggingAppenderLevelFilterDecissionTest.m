...
- (void)testWithParameter:(FilterLevelTestParameter *)parameter {
    ...
    DRYLoggingMessage *message = [[DRYLoggingMessage alloc] initWithMessage:nil level:parameter.messageLevel loggerName:nil framework:nil className:nil methodName:nil memoryAddress:nil byteOffset:nil threadName:nil];
