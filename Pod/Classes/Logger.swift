 ...
 *  #About log method#
 *
 *  Logger instances provide log method such as trace: or traceWithLineNumber:format:. These methods check if this logger's level
...
public protocol Logger {
     ...
     *
     *  @return YES if this logger's level is lower or equal to the given level. If this logger's level is LogLevel.off, the parent logger will be consulted, if there is one.
     */
